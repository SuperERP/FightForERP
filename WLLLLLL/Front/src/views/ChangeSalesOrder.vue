        ...
        <el-row :gutter="10">
          ...
          <el-col  :span="6">
            <el-form-item label="Total Cnty Percent(%):" prop="totalCntyPercent">
              <el-input style="width:110px;" size='mini' v-model="form.totalCntyPercent"></el-input>
            </el-form-item></el-col>
          <el-col :span="6">
...
export default {
  ...
  methods: {
    ...
    // 激活整体折扣
    cntyActivate () {
      if (this.form.totalCnty === '' | this.form.totalCntyPercent === '') {
        this.$message.error('Please Enter Total Cnty and Total Cnty Percent!')
      } else {
        ExpectOrdVal = 0
        var temp = 0
        var price = 20
